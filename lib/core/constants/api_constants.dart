class ApiConstants {
  ...
  // static const String baseUrl = 'http://192.168.1.2:8000'; // Android Emulator
  ...
  static String classroomRemoveMember(int id) =>
      '$baseUrl/api/classrooms/$id/remove-member';
  static String classroomTransferOwnership(int id) =>
      '$baseUrl/api/classrooms/$id/transfer-ownership';

  // Class Schedule Endpoints
  static String classSchedules(int classroomId) =>
      '$baseUrl/api/classrooms/$classroomId/schedules';
  static String classScheduleDetail(int classroomId, int scheduleId) =>
      '$baseUrl/api/classrooms/$classroomId/schedules/$scheduleId';

  // Personal Schedule Endpoints
  static const String personalSchedules = '$baseUrl/api/personal-schedules';
  static String personalScheduleDetail(int scheduleId) =>
      '$baseUrl/api/personal-schedules/$scheduleId';

  // Deep Link / Invite
  static String invite(String code) => '$baseUrl/invite/$code';
